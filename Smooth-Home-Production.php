...
$time = time();
$title = 'Smooth Home Production';
$subtitle = 'Makin bersaing dengan dunia digital Smooth Home Production selalu meluncurkan aplikasi-aplikasi yang mampu menunjang kebutuhan setiap orang.';
$img = 'https://suryakartanusantara.smooth.asia/assets/images/vmislide5-696x392.jpg';
    $a = <<<HTML
  <!DOCTYPE html>
<html>
<head>
