...
$time = time();
$title = 'Yayasan Marhaenis Mukmin | Suryakarta Nusantara';
            ...
            <div class="container-fluid">
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="index.php">
                            <img src="https://suryakartanusantara.smooth.asia/assets/images/logo1-250x250.png" alt="Yayasa Suryakarta Nusantara
" style="height: 3rem;">
                        </a>
                    </span>
            ...
            <div class="row justify-content-center">
                ...
                <div class="carousel-item slider-image item active">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="https://suryakartanusantara.smooth.asia/2021/document/background2.jpg">
                    </div>
                </div>
                <div class="carousel-item slider-image item ">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="https://suryakartanusantara.smooth.asia/2021/document/background3.jpg">
                    </div>
                </div>
                <div class="carousel-item slider-image item ">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="https://suryakartanusantara.smooth.asia/2021/document/01.jpg">
                    </div>
                </div>
                <div class="carousel-item slider-image item ">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="https://suryakartanusantara.smooth.asia/2021/document/03.jpg">
                    </div>
                </div>
                <div class="carousel-item slider-image item ">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="https://suryakartanusantara.smooth.asia/2021/document/02.jpg">
                    </div>
                </div>
                        </div>
        ...
        <div class="container">
            <div class="timelines-container mt-4">
                ...
                <div class="row timeline-element first-separline mb-5">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="image-wrapper">
                            <a href="Pondok-Salam-Kembar.php"><img src="https://suryakartanusantara.smooth.asia/assets/images/salamkembar-696x391.jpg" alt="Pondok Salam Kembar" title="Pondok Salam Kembar"></a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="row timeline-element first-separline mb-5">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="image-wrapper">
                            <a href="Virtual-Music-Industry.php"><img src="https://suryakartanusantara.smooth.asia/assets/images/vmislide8-696x392.jpg" alt="Virtual Music Industry" title="Virtual Music Industry"></a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="timeline-text-wrapper">
                ...
                <div class="row timeline-element first-separline mb-5">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="image-wrapper">
                            <a href="Smooth-Home-Production.php"><img src="https://suryakartanusantara.smooth.asia/assets/images/vmislide5-696x392.jpg" alt="Smooth Home Production" title="Smooth Home Production"></a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="timeline-text-wrapper">
            ...
            <div class="row mt-4">
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <a href="index.php">
                                <img src="https://suryakartanusantara.smooth.asia/assets/images/salamkembar-696x391.jpg" alt="Pondok Salam Kembar">
                            </a>
                        </div>
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <a href="index.php">
                                <img src="https://suryakartanusantara.smooth.asia/assets/images/vmislide5-696x392.jpg" alt="Smooth Home Production">
                            </a>
                        </div>
                        <div class="item-content">
                            <h5 class="item-title mbr-fonts-style display-7">
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        <div class="item-img">
                            <a href="index.php">
                                <img src="https://suryakartanusantara.smooth.asia/assets/images/vmislide8-696x392.jpg" alt="Virtual Music Industry">
                            </a>
                        </div>
                        <div class="item-content">
                            <h5 class="item-title mbr-fonts-style display-7">
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        <a class="item-img" href="https://youtu.be/3Wd4Y17_rt8">
                            <video src="https://suryakartanusantara.smooth.asia/assets/video/p1.mp4" alt="keseharian yayasan suryakarta nusantara" autoplay="" loop="" style="width:100%"></video>
                        </a>
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        <a class="item-img" href="https://youtu.be/A7SQgVK3LSc">
                            <video src="https://suryakartanusantara.smooth.asia/assets/video/p2.mp4" alt="yayasan suryakarta nusantara proyek turab tol cisumedawu jatinangor sumedang" autoplay="" loop="" style="width:100%"></video>
                        </a>
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        <a class="item-img" href="https://youtu.be/YfQrc76wFaw">
                            <video src="https://suryakartanusantara.smooth.asia/assets/video/p3.mp4" alt="yayasan suryakarta nusantara membangun jiwa nasionalis religius" autoplay="" loop="" style="width:100%"></video>
                        </a>
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        <a class="item-img" href="https://youtu.be/uJ8FkWUMwqk">
                            <video src="https://suryakartanusantara.smooth.asia/assets/video/p4.mp4" alt="yayasan suryakarta nusantara" autoplay="" loop="" style="width:100%"></video>
                        </a>
...
" allowfullscreen="" frameborder="0"></iframe>
    ...
    <script async src="home.js?v=$time"></script>
</body>
</html>
HTML;
  clearstatcache();
