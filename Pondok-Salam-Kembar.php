...
$time = time();
$title = 'Pondok Salam Kembar';
$subtitle = 'Tidak hanya ber-Agama namun pondok ini mampu melahirkan santri-santri berjiwa nasionalis. Terlihat jelas saat pelaksanaan upacara hari pancasaila yang berlansung di pondok Salam Kembar Tholabussalaam yang berlokasi di kayupuring kec. Grabag Magelang.';
$img = 'https://suryakartanusantara.smooth.asia/assets/images/salamkembar-696x391.jpg';
	$a = <<<HTML
  <!DOCTYPE html>
<html>
<head>
