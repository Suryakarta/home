        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="title col-md-12 col-lg-12">
                    ...
                    <h4 class="mbr-section-subtitle align-center mbr-fonts-style mb-4 display-5">"${a.visimisi.visi.title}"</h4>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-7">
                    <blockquote>${a.visimisi.visi.subtitle}</blockquote>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="title col-md-12 col-lg-12">
                    ...
                    <h4 class="mbr-section-subtitle align-center mbr-fonts-style mb-4 display-5">"${a.visimisi.misi.title}"</h4>
                </div>
            </div>
        </div>
    </section>
    <section class="content7 cid-sCDQHVtRHR" id="content7-4">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-7">
                    <blockquote>${a.visimisi.misi.subtitle}</blockquote>
                </div>
            </div>
        </div>
    </section>
